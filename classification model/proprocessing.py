    ...
    #             get the list of images
                    ...
                    for image_name in tqdm.tqdm(image_names):
                        ...
                        try:
                            ...
                            # image file memory me read hori hai
                        ...
                        valid_image_count += 1
                        # “Ye code check karta hai ki image RGB format me hai ya nahi.
# Uske baad MoveNet body keypoints detect karta hai.
# Phir confidence score check hota hai, aur agar detection accurate nahi hoti toh image skip ho jati hai.
# Valid image hone par counter increase ho jata hai.”
            ...
            print(self._message)
# “Ye code detected body keypoints ke x, y coordinates aur confidence scores extract karta hai.
# Phir unhe array aur single-row format me convert karke CSV file me save karta hai for model training.
...
train_preprocessor = Preprocessor(
    images_in_folder,#TRAINING IMAGES PROCESS HORI H
    csvs_out_path
)
...
# “Ye code training aur testing yoga images ko preprocess karta hai.
# MoveNet body landmarks detect karta hai aur unhe train_data.csv aur test_data.csv files me save karta hai for model training and testing.”            # 
